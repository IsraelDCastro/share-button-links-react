...
export default function ButtonWhatsappIcon ({ url, message, isRounded }) {
	return (
		<a href={ `https://api.whatsapp.com/send?text=${ message }%20${ url }` }
		   className={ `btn-link-icon btn-link-whatsapp-icon ${isRounded ? "is-rounded" : null}` }
		   title="Whatsapp" rel="nofollow noopener noreferrer" target="_blank">
