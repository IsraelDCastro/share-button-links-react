...
export default function ButtonTumblrIcon ({ url, title, content, isRounded }) {
	return (
		<a href={ `https://www.tumblr.com/widgets/share/tool?posttype=link&title=${title}&caption=${url}&content=${content}&canonicalUrl=${url}&shareSource=tumblr_share_button` }
		   className={ `btn-link-icon btn-link-tumblr-icon ${isRounded ? "is-rounded" : null}` }
		   title="Tumblr"
		   rel="noreferrer nofollow noopener" target="_blank">
			<svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="tumblr-square"
			     className="svg-inline--fa fa-tumblr-square fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg"
			     viewBox="0 0 448 512">
