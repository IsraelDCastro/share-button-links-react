        ...
        <div className="bg-white content flex-1">
          <div id="installation" className="mb-8 p-8">
            ...
            <p className="mt-4">
              ...
              <span className="bg-gray-100 px-1">{`@import 'share-button-links-react/main.css';`}</span> or{" "}
              <span className="bg-gray-100 px-1">{`@import 'share-button-links-react/main.scss';`}</span>.
            </p>
            <p>
