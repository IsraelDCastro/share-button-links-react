...
export default function ButtonTelegram({
  ...
  const href = buildShareUrl("https://t.me/share/url", { url: shareUrl, text: message });

  return (
    <a
      href={href}
      className={getButtonClassNames("btn-link btn-link-telegram", { isRounded, isBordered, isCircled, colorVariant })}
      title="Telegram"
