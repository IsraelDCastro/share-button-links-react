...
export default function ButtonWhatsapp({
  ...
  const href = buildShareUrl("https://api.whatsapp.com/send", { text: joinTextParts(message, shareUrl) });

  return (
    <a
      href={href}
      className={getButtonClassNames("btn-link btn-link-whatsapp", { isRounded, isBordered, isCircled, colorVariant })}
      title="WhatsApp"
