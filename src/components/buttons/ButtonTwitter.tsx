...
export default function ButtonTwitter({
  ...
  const href = buildShareUrl("https://twitter.com/intent/tweet/", { text: title, url: shareUrl });

  return (
    <a
      href={href}
      className={getButtonClassNames("btn-link btn-link-twitter", { isRounded, isBordered, isCircled, colorVariant })}
      title="Twitter"
